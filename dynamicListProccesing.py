...
app = Flask(__name__)
connectionString = "mongodb+srv://Nox:8R6irLgyJLRu4Pe0@financialsite.twzysgz.mongodb.net/?retryWrites=true&w=majority&appName=FinancialSite"
client = MongoClient(connectionString)
db = client['FinancialSiteBase']
transactionCollection = db['Transactions']
userCollection = db['Users']
financesCollection = db['Finances']
app.secret_key = 'A53bR2d430UDUffnGQFU'

app.config['MAIL_SERVER'] = 'smtp.gmail.com'
app.config['MAIL_PORT'] = 587
app.config['MAIL_USE_TLS'] = True
app.config['MAIL_USERNAME'] = 'korshunov.maks09@gmail.com'
app.config['MAIL_PASSWORD'] = 'wtsa opuo itsp kymm '
